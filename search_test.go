...
func TestRenderPage_SearchQueryFiltersFiles(t *testing.T) {
	...
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{"q": []string{"cat"}}, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_EmptySearchShowsAllFiles(t *testing.T) {
	...
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{"q": []string{""}}, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00")
	if err != nil {
		t.Fatal(err)
	}
	if !strings.Contains(html, "cat.jpg") {
