...
func TestRenderPage_ContainsImagesAndFilenames(t *testing.T) {
	...
	html, err := RenderPage("Test Gallery", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
...
func TestRenderPage_NoOtherFilesSectionWhenEmpty(t *testing.T) {
	...
	html, err := RenderPage("x", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_HTMLIsValidish(t *testing.T) {
	...
	html, err := RenderPage("t", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_DirectoriesAlwaysRendered(t *testing.T) {
	...
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 30, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_PaginationLinksPresent(t *testing.T) {
	...
	// Test page 2
	q := url.Values{"page": {"2"}}
	html2, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 30, []string{"30", "60", "120", "all"}, files, q, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_PerPageTextInHeader(t *testing.T) {
	...
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 10, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
	...
	html25, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 25, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_HeaderShowsPageCount(t *testing.T) {
	...
	html2, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 10, []string{"30", "60", "120", "all"}, files2, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_SortUITogglesDirection(t *testing.T) {
	...
	html, _ := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	...
	html, _ = RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, q, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
...
func TestRenderPage_TileMetadata(t *testing.T) {
	...
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_EmptyDirShowsEmptyMessage(t *testing.T) {
	html, err := RenderPage("empty", "./", "./_thumbs/", "", "", false, false, false, 0, nil, nil, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_UpEntryInSubdir(t *testing.T) {
	...
	html, err := RenderPage("subdir", "./", "./_thumbs/", "subdir", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_NoUpEntryAtRoot(t *testing.T) {
	...
	html, err := RenderPage("root", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestSplitFiles_DirsUnaffectedByImageSort(t *testing.T) {
	...
	for _, sortSpec := range []string{"mtime", "name", "size"} {
		for _, order := range []string{"asc", "desc"} {
			...
			q.Set("sort", sortSpec)
			q.Set("order", order)
			html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, q, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
			if err != nil {
...
func TestRenderPage_VideoThumbnailRendering(t *testing.T) {
	...
	t.Run("video thumb disabled (noVideoThumbs=true) → no <img class=\"thumb-img\">, placeholder shown", func(t *testing.T) {
		html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, true, true, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
		if err != nil {
			t.Fatal(err)
		}
		if strings.Contains(html, `class="thumb-img"`) {
...
func TestRenderPage_GoogleStylePagination(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 8, []string{"8", "16", "30", "60", "120", "all"}, files25, q, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
			if err != nil {
				t.Fatal(err)
			}
	...
	q := url.Values{"page": {"2"}}
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 50, []string{"30", "50", "60", "120", "all"}, files4, q, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
	navStart := strings.Index(html, `<nav class="pagination">`)
...
func TestRenderPage_HeaderShowsPagePosition(t *testing.T) {
	...
	q := url.Values{"page": {"2"}}
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 60, []string{"30", "60", "120", "all"}, files, q, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
	metaStart := strings.Index(html, `class="meta"`)
...
func TestRenderPage_HeaderSeparatesImageAndVideoCounts(t *testing.T) {
	...
	html2, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, filesNoVideo, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
	metaStart2 := strings.Index(html2, `class="meta"`)
	...
	html3, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, filesAllVideo, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_UpEntryShowsParentDirName(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			html, err := RenderPage("test", "./", "./_thumbs/", tc.relPath, "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
			if err != nil {
				t.Fatal(err)
			}
			if tc.wantText == "" {
...
func TestRenderPage_OtherFilesRespectSort(t *testing.T) {
	...
	t.Run("sort=name,asc: others sorted alphabetically (apple, mango, zebra)", func(t *testing.T) {
		html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{"sort": []string{"name"}, "order": []string{"asc"}}, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("sort=name,desc: others sorted reverse-alpha (zebra, mango, apple)", func(t *testing.T) {
		html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{"sort": []string{"name"}, "order": []string{"desc"}}, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
		if err != nil {
			t.Fatal(err)
		}
		got := extractOrder(html)
	...
	t.Run("sort=mtime,asc: others sorted by mtime asc (zebra, apple, mango)", func(t *testing.T) {
		...
		html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{"sort": []string{"mtime"}, "order": []string{"asc"}}, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
		if err != nil {
			t.Fatal(err)
		}
		got := extractOrder(html)
	...
	t.Run("sort=size,asc: others sorted by size asc (zebra 100, apple 200, mango 300)", func(t *testing.T) {
		html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{"sort": []string{"size"}, "order": []string{"asc"}}, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
		if err != nil {
			t.Fatal(err)
		}
		got := extractOrder(html)
...
func TestRenderPage_DirectoriesIgnoreSort(t *testing.T) {
	...
	for _, s := range sortSelections {
		t.Run("sort="+s.field+",order="+s.order+": dirs stay alphabetical", func(t *testing.T) {
			html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{"sort": []string{s.field}, "order": []string{s.order}}, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
			if err != nil {
				t.Fatal(err)
			}
...
func TestRenderPage_Phase75HorizontalLinesSameWidth(t *testing.T) {
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, nil, nil, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_Phase77DirsTableNoTypeColumn(t *testing.T) {
	...
	upHTML, err := RenderPage("test", "./", "./_thumbs/", "subdir", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_TotalFilesInMetaLine(t *testing.T) {
	...
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", tr, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
	if err != nil {
	...
	noFiles, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, nil, nil, nil, nil, nil, nil, "", "", "substring", "en", tr, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
	...
	oneHTML, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, nil, oneFile, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_Phase79HeadingCounts(t *testing.T) {
	...
	rootHTML, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
	...
	deepFiles := []FileInfo{}
	deepHTML, err := RenderPage("deep", "./", "./_thumbs/", "deep", "", false, false, false, 0, nil, deepFiles, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_TypeFilter(t *testing.T) {
	...
	all, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{}, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
	...
	img, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{
		"type": {"jpg,png"},
	}, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_Breadcrumb(t *testing.T) {
	...
	html, err := RenderPage("images", "./", "./_thumbs/", "photos/2024/", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{}, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_Breadcrumb_PreservesFilter(t *testing.T) {
	...
	html, err := RenderPage("title-not-used", "./", "./_thumbs/", "images/photos/", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{
		"type": {"jpg,png"},
	}, defaultImageExts, defaultVideoExts, defaultVideoExts, "images", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_DirLinkHref_PreservesAllQueryParams(t *testing.T) {
	files := []FileInfo{{Name: "a.jpg", ModTime: 1, Size: 100, Kind: KindImage}}
	html, err := RenderPage("title-not-used", "./", "./_thumbs/", "photos/", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{
		"q":         {"tulip"},
		"type":      {"jpg,png"},
		"sort":      {"name"},
		"order":     {"desc"},
...
func TestRenderPage_DirLinkHref_EmptyQuery(t *testing.T) {
	files := []FileInfo{{Name: "a.jpg", ModTime: 1, Size: 100, Kind: KindImage}}
	html, err := RenderPage("title-not-used", "./", "./_thumbs/", "photos/", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{}, defaultImageExts, defaultVideoExts, defaultVideoExts, "images", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_SortLinksPreservePage(t *testing.T) {
	files := []FileInfo{{Name: "a.jpg", ModTime: 1, Size: 100, Kind: KindImage}}
	html, err := RenderPage("title-not-used", "./", "./_thumbs/", "images/", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{
		"sort":      {"name"},
		"order":     {"asc"},
		"page":      {"3"},
		"page_size": {"60"},
...
func TestComputeFilterGroups(t *testing.T) {
	...
	img, vid, _, other := computeFilterGroups(files, imgExts, vidExts, nil, activeFilter)
...
func TestComputeFilterGroups_Empty(t *testing.T) {
	img, vid, _, other := computeFilterGroups(nil, defaultImageExts, defaultVideoExts, nil, nil)
...
func TestComputeFilterGroups_NilFilter(t *testing.T) {
	files := []FileInfo{{Name: "a.jpg", ModTime: 1, Size: 100, Kind: KindImage}}
	img, _, _, _ := computeFilterGroups(files, defaultImageExts, defaultVideoExts, nil, nil)
	if img.Selected != 0 {
...
func TestRenderPage_FilterUI(t *testing.T) {
	...
	t.Run("no filter active", func(t *testing.T) {
		html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, defaultImageExts, defaultVideoExts, defaultVideoExts, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("with ?type=jpg filter", func(t *testing.T) {
		html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, url.Values{
			"type": {"jpg"},
		}, defaultImageExts, defaultVideoExts, defaultVideoExts, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
		if err != nil {
			t.Fatal(err)
		}
...
func TestRenderPage_PageSizeFromURL(t *testing.T) {
	...
	html60, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 60, []string{"30", "60", "120", "all"}, files, nil, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
	html120, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 60, []string{"30", "60", "120", "all"}, files, url.Values{"page_size": []string{"120"}}, nil, nil, nil, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_MediaHeader_RangeForPage1(t *testing.T) {
	...
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 60, []string{"30", "60", "120", "all"}, files, nil, defaultImageExts, defaultVideoExts, defaultVideoExts, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_MediaHeader_RangeForPage2(t *testing.T) {
	...
	q := url.Values{"page": {"2"}}
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 60, []string{"30", "60", "120", "all"}, files, q, defaultImageExts, defaultVideoExts, defaultVideoExts, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_MediaHeader_SearchApplied(t *testing.T) {
	...
	q := url.Values{"q": {"zzz"}}
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, q, defaultImageExts, defaultVideoExts, defaultVideoExts, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_SearchInputHasMatchModeAttr(t *testing.T) {
	...
	// Word mode
	html, err = RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, nil, defaultImageExts, defaultVideoExts, defaultVideoExts, "", "", "word", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_SearchQueryServerSide_WordMode(t *testing.T) {
	...
	q := url.Values{"q": {"cat"}}
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 0, []string{"30", "60", "120", "all"}, files, q, defaultImageExts, defaultVideoExts, defaultVideoExts, "", "", "word", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_PageSizeAll(t *testing.T) {
	...
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 30, []string{"30", "60", "120", "all"}, files, q, defaultImageExts, defaultVideoExts, defaultVideoExts, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRenderPage_SearchHeader_NoSearch(t *testing.T) {
	...
	html, err := RenderPage("test", "./", "./_thumbs/", "", "", false, false, false, 30, []string{"30", "60", "120", "all"}, files, nil, defaultImageExts, defaultVideoExts, defaultVideoExts, "", "", "substring", "en", nil, "00", "00", "00", "00", "00", false, false, "/tmp/dir", "/tmp/cache", "webp")
	if err != nil {
		t.Fatal(err)
	}
